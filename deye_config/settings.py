...
# DATABASE
# Detect if running on Railway using PostgreSQL, otherwise use SQLite for local development
if os.environ.get('PGHOST'):
    ...
    DATABASES = {
        'default': {
            ...
            'PASSWORD': os.environ.get('PGPASSWORD', 'VeXEBcLLaUYDlbdrAMkKAuYzaoPbvgJs'),
